...
# 2) Add mutators for all of the data attributes (number_of_rooms, square_feet, floors)
    def set_number_of_rooms(self, numbers_of_rooms):
        self.__number_of_rooms = numbers_of_rooms
...
def main():
    house = SingleFamilyHome(6, 1200, 1, 'single car garage', '.25')
# 8) Display the data using the accessor methods
    print("This house has", house.get_number_of_rooms(), "rooms over", house.get_floors(), "floor(s)", end="")
    print(" for a total of", house.get_square_feet(), "sqft")
    print("It has a", house.get_garage_type(), "and the yard is", house.get_yard_size() + ".")
